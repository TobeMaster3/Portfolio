...
> 책이나 동영상으로 이미 동작하는 코드들을 반복 학습하는것은  
> 스스로의 발전을 위해서 한계가 있다는것을 절감하였습니다.  
> 한편으로는, 내가 생각핸 코드와 구글링을 통한 코드를 함께 사용하면서 많은 문제와 직면했지만
> 문제들을 해결하는 과정에서 새로운 개념에 대해 알게 되고 끊임없는 고민을 통해
> 해결하는 과정을 거쳤을때는 성취감과 개발의 재미를 느끼게 되는 순간이였습니다.
> 개발자 = 문제를 해결하는 일 이기 때문에 스스로에게 주어진 역할과 문제를 잘 해결하기 위한 
> 저의 역량을 발전시키기 위해서 어떻게 학습을 해야하는지가 그려지는 좋은 기회였습니다
