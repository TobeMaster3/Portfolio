							...
							<div class="col-md-10 offset-md-1 col-lg offset-lg-0">
								<div class="widget write-form">
									...
									<div class="form-group" style="text-align:left;border:1px solid #e0e0e0;background-color:f9f9f9;padding:5px">
										...
										<!-- 버튼 part -->
										<div class="buttons">
											<input type="button" value="목록" class="btn btn-transparent" style="margin-top:20px; margin-right:10px;" onclick="location.href='/community/camplog.do'" />
											<input type="button" value="등록" class="btn btn-transparent" id="wbtn" style="margin-top:20px; float: right;" onclick="location.href='/community/writeOk.do'" />
										</div>
									</div>
								</div>
							</div>
