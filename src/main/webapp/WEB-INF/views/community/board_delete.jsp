	            ...
	            <div class="col-md-10 offset-md-1 col-lg offset-lg-0">
	              <div class="widget write-form">
	                ...
	                <div class="form-group">
	                  ...
	                  <input type="text" class="form-control" name="nick" value="${board.nick}">
	                </div>
	                ...
	                <div class="buttons" >
	                	...
	                	<input type="button" value="보기" class="btn btn-transparent" style="margin-top:20px;" onclick="location.href='/community/view.do?pseq=${board.pseq}'" />
