...
<jsp:include page="../../component/header.jsp"></jsp:include>
	...
	<section class="modify section">
		<form action="/community/modifyOk.do" method="post" name="mfrm" enctype="multipart/form-data">
			<input type="hidden" name="pseq" value="${board2.pseq}" />
			<input type="hidden" name="type" value="${board2.type}" />
				<div class="container">
					<div class="row">
								...
								<div class="col-md-10 offset-md-1 col-lg offset-lg-0">
									<div class="widget write-form">
										...
										<div class="form-group">
											...
											<input type="text" class="form-control" name="title" value="${board2.title}">
										</div>	
										
										<!-- 내용 입력 part --> 
										<div class="value">
											<div class="form-group">
												<textarea class="form-control" rows="10" id="content" name="content" >${board2.content}</textarea>
												<script>
